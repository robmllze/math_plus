...
extension List_Series on List<num> {
  ...
  num fractile(
    ...
    final _extent = m - n;
    final _sorted =
        asSmallToLarge ? this.asSmallToLarge() : this.asLargeToSmall();
  ...
  double largest() {
    ...
    for (final component in this)
      if (component > _res) _res = component as double;
    return _res;
  }
  ...
  /// smallest to largest.
  List<num> asSmallToLarge() =>
      List<num>.of(this)..sort((a, b) => a.compareTo(b));

  /// Generates a new Series from this Series with components sorted from
  /// largest to smallest.
  List<num> asLargeToSmall() =>
